 ...
 */
final class Version20220115171647 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprises_id INT NOT NULL, intitule VARCHAR(150) NOT NULL, mission VARCHAR(1000) DEFAULT NULL, adresse_mail VARCHAR(25) DEFAULT NULL, INDEX IDX_C27C9369A70A18EC (entreprises_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
